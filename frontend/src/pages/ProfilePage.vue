...
<style scoped>
.profile-shell { background: var(--app-background); color: var(--ink); }
.profile-header { border-bottom: 1px solid var(--line); background: color-mix(in srgb, var(--app-background) 72%, white); color: var(--ink); backdrop-filter: blur(20px); }
.profile-footer { background: transparent; }
...
.profile-brand > span { display: grid; width: 38px; height: 38px; border-radius: 13px; background: linear-gradient(135deg, var(--mint), var(--brand)); place-items: center; }
.profile-brand strong { color: var(--brand-dark); }
.profile-auth-wrap { display: grid; min-height: inherit; padding: 30px 18px; background: radial-gradient(circle at 15% 15%, color-mix(in srgb, var(--mint) 30%, transparent), transparent 35%), linear-gradient(145deg, color-mix(in srgb, var(--app-background) 70%, white), color-mix(in srgb, var(--app-background) 15%, white)); place-items: center; }
.profile-auth-card { width: min(520px, 100%); padding: clamp(24px, 4vw, 42px); border: 1px solid color-mix(in srgb, var(--brand) 18%, transparent); border-radius: 28px; box-shadow: 0 24px 70px color-mix(in srgb, var(--brand-dark) 10%, transparent); }
.auth-icon { display: grid; width: 58px; height: 58px; margin-bottom: 24px; border-radius: 19px; background: color-mix(in srgb, var(--mint) 28%, white); color: var(--brand-dark); font-size: 30px; place-items: center; }
.eyebrow, .card-heading span { color: var(--brand-dark); font-size: .68rem; font-weight: 850; letter-spacing: .14em; }
...
.profile-auth-card p, .profile-hero p { color: var(--muted); line-height: 1.6; }
.neutral-note, .activation-note { background: color-mix(in srgb, var(--brand) 10%, transparent); color: color-mix(in srgb, var(--brand-dark) 68%, var(--ink)); font-size: .8rem; }
