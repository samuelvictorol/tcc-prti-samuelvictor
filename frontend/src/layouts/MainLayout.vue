...
const navigation = computed(() => [
  ...
  { label: 'Whitelabel', caption: 'Marca e armazenamento', icon: 'palette', to: '/whitelabel', available: true },
  ...
  <q-layout view="lHh Lpr lFf" class="app-shell">
    <q-header class="app-header glass">
      <q-toolbar class="app-toolbar">
        ...
        <WhiteLabelBrand compact class="brand--compact" />
        <q-space />
    ...
    >
      <div class="drawer-content">
        <WhiteLabelBrand class="drawer-brand" />
...
.app-header {
  ...
  background: color-mix(in srgb, var(--app-background) 68%, white 32%);
  color: var(--ink);
}
...
.app-drawer {
  ...
  background: color-mix(in srgb, var(--app-background) 82%, white 18%);
...
.nav-item {
  ...
  margin: 3px 0;
  border-radius: 14px;
  color: color-mix(in srgb, var(--ink) 77%, var(--app-background));
}

.nav-item .q-icon {
  color: color-mix(in srgb, var(--brand-dark) 62%, var(--muted));
}

.nav-item--active {
  background: linear-gradient(105deg, color-mix(in srgb, var(--mint) 40%, transparent), color-mix(in srgb, var(--brand) 14%, transparent));
  color: var(--brand-dark);
  font-weight: 750;
}
...
.nav-item--useful {
  border: 1px solid transparent;
  background: linear-gradient(105deg, color-mix(in srgb, var(--mint) 12%, transparent), color-mix(in srgb, white 35%, transparent));
}

.nav-item--useful:hover {
  border-color: color-mix(in srgb, var(--brand) 16%, transparent);
  background: linear-gradient(105deg, color-mix(in srgb, var(--mint) 22%, transparent), color-mix(in srgb, var(--brand) 8%, transparent));
  color: var(--brand-dark);
}
...
.drawer-footer {
  ...
  color: color-mix(in srgb, var(--brand-dark) 60%, var(--ink));
  font-size: 0.78rem;
}
...
.admin-history-dialog__footer {
  z-index: 2;
  flex: none;
  background: color-mix(in srgb, var(--app-background) 10%, white);
}
...
.admin-notification-context {
  ...
  overflow: auto;
  border-radius: 12px;
  background: color-mix(in srgb, var(--brand-dark) 46%, var(--ink));
  color: color-mix(in srgb, var(--mint) 34%, white);
